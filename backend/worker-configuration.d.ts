/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 59cec779907e298e3450d087d49276fe)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		flare_gpt: D1Database;
		VECTOR_INDEX: VectorizeIndex;
		INDEXING_QUEUE: Queue;
		JWT_SECRET: SecretsStoreSecret;
		GOOGLE_CLIENT_ID: SecretsStoreSecret;
		GOOGLE_CLIENT_SECRET: SecretsStoreSecret;
		GOOGLE_REDIRECT_URI: SecretsStoreSecret;
		UPSTASH_REDIS_REST_TOKEN: SecretsStoreSecret;
		SEARCHAPI_KEY: SecretsStoreSecret;
		FRONTEND_URL: SecretsStoreSecret;
		AI: Ai;
		AI_MODEL: "@cf/meta/llama-3.1-8b-instruct";
		UPSTASH_REDIS_REST_URL: "https://happy-rhino-108966.upstash.io";
		PUBLIC_FRONTEND_ORIGIN: "https://flaregpt.innovchromatic.me";
		PUBLIC_OAUTH_REDIRECT_URI: "https://backend.innovchromatic.me/auth/google/callback";
		JWT_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODEL" | "UPSTASH_REDIS_REST_URL" | "PUBLIC_FRONTEND_ORIGIN" | "PUBLIC_OAUTH_REDIRECT_URI" | "JWT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_REDIRECT_URI">> {}
}
